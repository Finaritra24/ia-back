...
public class ServPublication {
    ...
    public static void ajoutPub(String nom, String descr, String img,String extimg,String id) throws Exception{
        Publication pub=new Publication(id,nom,datecurrent(),descr,img,extimg);
